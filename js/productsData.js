...
let shoes = [
  {
    ...
    description:
      "The Air Jordan 1 Retro High OG 'Yellow Toe' showcases a familiar color scheme that first appeared on the 'Black Toe' Jordan 1 in 1985. ",
  },
  {
    id: 12,
    isAvailable: true,
    ...
    description:
      "The Nike Metcon 9 is designed for heavy lifting like squats and snatches. It features a flat, wide heel and a flexible forefoot for stability and comfort ",
  },
  {
    id: 3,
    isAvailable: true,
    ...
    description:
      "The Nike Air Zoom BB NXT is designed to help players feel light, secure and responsive. You can see the Nike Air Zoom cushioning through a window on the outsole. ",
  },
  ...
  },
  {
    ...
    description:
      "The Air Jordan 1 Low SE is the perfect, easy-to-wear sneaker. The classic design and elevated materials create a look that's versatile enough for everyday wear.",
  },
  {
    id: 5,
    isAvailable: true,
...

  {
    ...
    image:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/9caabd31-67b5-4ce6-84c4-b2cd35f10292/air-max-2017-mens-shoes-BVqnkV.png",
    description:
      "The Nike Air Max Pulse is inspired by the feeling of your heart pounding as you run and the rhythm of your feet on the pavement. It features a flat, wide sole.",
  },
  {
    id: 10,
    isAvailable: true,
